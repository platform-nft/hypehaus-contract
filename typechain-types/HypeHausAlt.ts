...
export interface HypeHausAltInterface extends utils.Interface {
  contractName: "HypeHausAlt";
  functions: {
...
export interface HypeHausAlt extends BaseContract {
  contractName: "HypeHausAlt";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HypeHausAltInterface;
